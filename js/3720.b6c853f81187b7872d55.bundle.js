"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[3720],{
...
;// CONCATENATED MODULE: ./src/views/apps/parent/edit/Account.js
...
var UserAccountTab = function UserAccountTab(_ref) {
  ...
  var _useState11 = (0,react.useState)(data.phone2),
      _useState12 = (0,slicedToArray/* default */.Z)(_useState11, 2),
      phone2 = _useState12[0],
      setPhone2 = _useState12[1];

  var _useState13 = (0,react.useState)(data.avatar),
      _useState14 = (0,slicedToArray/* default */.Z)(_useState13, 2),
      avatar = _useState14[0],
      setAvatar = _useState14[1];

  var _useState15 = (0,react.useState)(data.blocked),
      _useState16 = (0,slicedToArray/* default */.Z)(_useState15, 2),
      blocked = _useState16[0],
      setBlocked = _useState16[1];
  ...
  var _useState21 = (0,react.useState)([]),
      ...
      setStudents = _useState22[1];

  var _useState23 = (0,react.useState)([]),
      _useState24 = (0,slicedToArray/* default */.Z)(_useState23, 2),
      children = _useState24[0],
      setChildren = _useState24[1];
  ...
  var handleChildren = function handleChildren(list) {
    var returnList = [];
    (list || []).forEach(function (l) {
      returnList.push({
        value: l.studentId,
    ...
    setChildren(returnList);
  };

  var isSaveDisabled = email && !(0,Utils/* validateEmail */.oH)(email) || !name || !(children !== null && children !== void 0 && children.length);
  ...
  var onSubmit = function onSubmit(e) {
    ...
    if (!isSaveDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* PARENT_URL */.gV, id, {
        username: username,
        email: email,
        name: name,
        phone: phone,
        ...
        children: [error && /*#__PURE__*/(0,jsx_runtime.jsxs)(Alert/* default */.Z, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)(Field/* default */.Z, {
              ...
              name: "phone2",
              placeholder: "",
              invalid: submitted && phone2 && phone2.length !== 10,
              invalidtext: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
                id: "phoneLengthError"
              }),
              onChange: function onChange(e) {
...
;// CONCATENATED MODULE: ./src/views/apps/parent/edit/PasswordTabContent.js
...
var PasswordTabContent = function PasswordTabContent(_ref) {
  ...
  var onSubmit = function onSubmit(e) {
    ...
    if (!isSaveDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* CHANGE_STUDENT_PASSWORD_URL */.cd, data.userId, {
        password1: password1,
        password2: password2
...
;// CONCATENATED MODULE: ./src/views/apps/parent/edit/index.js
...
var UserEdit = function UserEdit() {
  ...
  var getData = function getData() {
    (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* PARENT_URL */.gV, id], true, react_toastify_esm/* toast */.Am, dispatch, "", "", function (data) {
      return setData(data);
    }, function (err) {
      return onFail(err);
    });
