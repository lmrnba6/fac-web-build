"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[3096],{
...
;// CONCATENATED MODULE: ./src/views/apps/promotion/list/columns.js
// ** React Imports
 // ** Custom Components
...
var columns = function columns(deletePromotion, editPromotion, viewPromotion, ability, intl) {
  return [{
    ...
    sortable: false,
    cell: function cell(row) {
      return "".concat(row.value, " ").concat(row.type === "amount" ? intl.formatMessage({
        id: "da"
      }) : row.type === "percentage" ? "%" : "");
    }
  }, {
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* default */.Z, {
        pill: true,
        color: row.status !== "visible" ? "light-danger" : "light-success",
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(UncontrolledDropdown/* default */.Z, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownToggle/* default */.Z, {
          ...
          right: true,
          children: [ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.PROMOTION_SUBJECT */.k.PROMOTION_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
          ...
          }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.PROMOTION_SUBJECT */.k.PROMOTION_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            className: "w-100",
            onClick: function onClick() {
              return deletePromotion(row.id);
            },
...
;// CONCATENATED MODULE: ./src/views/apps/promotion/list/Sidebar.js
...
var Sidebar = function Sidebar(props) {
  ...
  var _useState3 = (0,react.useState)(promotion.value),
      _useState4 = (0,slicedToArray/* default */.Z)(_useState3, 2),
      value = _useState4[0],
      setValue = _useState4[1];

  var _useState5 = (0,react.useState)(promotion.name || ""),
      _useState6 = (0,slicedToArray/* default */.Z)(_useState5, 2),
      name = _useState6[0],
      setName = _useState6[1];

  var _useState7 = (0,react.useState)(promotion.status || "visible"),
      _useState8 = (0,slicedToArray/* default */.Z)(_useState7, 2),
      status = _useState8[0],
      setStatus = _useState8[1];

  var _useState9 = (0,react.useState)(promotion.type || "amount"),
      _useState10 = (0,slicedToArray/* default */.Z)(_useState9, 2),
      type = _useState10[0],
      setType = _useState10[1];

  var _useState11 = (0,react.useState)(promotion.description),
  ...
  var handlePromotionsFetched = function handlePromotionsFetched(res) {
    setValue(res.amount);
  ...
  var initPromotion = function initPromotion() {
    if (promotion.id) {
      (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* PROMOTION_URL */.OA, promotion.id], true, react_toastify_esm/* toast */.Am, dispatch, "", "somethingWrong", handlePromotionsFetched, toggleSidebar);
    }
  };
  ...
  var isSaveButtonDisabled = !value || !name || !type;

  var onPromotionSuccess = function onPromotionSuccess() {
    toggleSidebar();
    refresh();
  };
  ...
  var onCreate = function onCreate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* insert */.$T, [api_urls/* PROMOTION_URL */.OA, {
        value: value,
        type: type,
        status: status,
        description: description,
        name: name
      }], true, react_toastify_esm/* toast */.Am, dispatch, "promotionCreatedSuccessfully", "", onPromotionSuccess, onFail);
    }
  };
  ...
  var onUpdate = function onUpdate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* PROMOTION_URL */.OA, promotion.id, {
        ...
        status: status,
        name: name
      }], true, react_toastify_esm/* toast */.Am, dispatch, "promotionUpdatedSuccessfully", "", onPromotionSuccess, onFail);
    }
  };
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ModalHeader/* default */.Z, {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsx)("h5", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
          id: "".concat(promotion.id ? "edit" : "add", "Promotion")
        })
      })
      ...
      children: [error && /*#__PURE__*/(0,jsx_runtime.jsxs)(es_Alert/* default */.Z, {
        ...
        onSubmit: promotion.id ? onUpdate : onCreate,
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Field/* default */.Z, {
          ...
          id: "value",
          name: "value",
          type: type === "amount" || type === "percentage" ? "number" : "text",
          ...
          append: {
            icon: type === "amount" ? intl.formatMessage({
              id: "da"
            }) : type === "percentage" ? intl.formatMessage({
              id: "percent"
            }) : ""
          },
          prepend: {
            icon: /*#__PURE__*/(0,jsx_runtime.jsx)("i", {
              class: "fa-solid fa-".concat(type === "amount" ? "dollar-sign" : type === "percentage" ? "percentage" : "gift")
            })
          }
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)(Field/* default */.Z, {
          label: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
...
;// CONCATENATED MODULE: ./src/views/apps/promotion/list/Table.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Row/* default */.Z, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.PROMOTION_SUBJECT */.k.PROMOTION_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
          color: "primary",
          onClick: onAdd,
...
var PromotionList = function PromotionList() {
  ...
  var _useState11 = (0,react.useState)({}),
      _useState12 = (0,slicedToArray/* default */.Z)(_useState11, 2),
      promotion = _useState12[0],
      setPromotion = _useState12[1];
  ...
  var getData = function getData(pageIndex, pageSize, order, filter) {
    (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* PROMOTIONS_URL */.k6, pageIndex, pageSize, order, filter], true, react_toastify_esm/* toast */.Am, dispatch, null, "somethingWrong", handleData, null);
  };
  ...
  var deletePromotion = function deletePromotion(id) {
    (0,Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* PROMOTION_URL */.OA, id], true, react_toastify_esm/* toast */.Am, dispatch, "promotionDeletedSuccessfully", "somethingWrong", function () {
  ...
  var editPromotion = function editPromotion(s) {
    setPromotion(s);
    toggleSidebar();
  };

  var viewPromotion = function viewPromotion(s) {
    setPromotion(s);
    toggleDetails();
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(index_cjs/* default */.ZP, {
          ...
          columns: columns(deletePromotion, editPromotion, viewPromotion, ability, intl),
...
/* harmony default export */ var Table = (PromotionList);
;// CONCATENATED MODULE: ./src/views/apps/promotion/list/index.js
// ** User List Component
// ** Styles
