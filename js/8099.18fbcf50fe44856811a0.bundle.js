"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[8099],{
...
;// CONCATENATED MODULE: ./src/views/apps/staff/edit/Account.js
...
var UserAccountTab = function UserAccountTab(_ref) {
  ...
  var _useState29 = (0,react.useState)(false),
      ...
      cameraOpen = _useState30[0],
      setCameraOpen = _useState30[1];

  var _useState31 = (0,react.useState)(false),
      _useState32 = (0,slicedToArray/* default */.Z)(_useState31, 2),
      imageOpen = _useState32[0],
      setImageOpen = _useState32[1];

  var intl = (0,useIntl/* default */.Z)();
  var isSaveDisabled = email && !(0,Utils/* validateEmail */.oH)(email) || !name || !dob || !role;
  ...
  var onSubmit = function onSubmit(e) {
    ...
    if (!isSaveDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* STAFF_URL */.Z2, id, {
        username: username,
        email: email,
        name: name,
        phone: phone,
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Media/* default */.Z, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "position-relative w-1-- d-flex align-items-center justify-content-center",
...
;// CONCATENATED MODULE: ./src/views/apps/staff/edit/PasswordTabContent.js
...
;// CONCATENATED MODULE: ./src/views/apps/staff/edit/index.js
...
var UserEdit = function UserEdit() {
  ...
  var getData = function getData() {
    (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* STAFF_URL */.Z2, id], true, react_toastify_esm/* toast */.Am, dispatch, "", "", function (data) {
      return setData(data);
    }, function (err) {
      return onFail(err);
    });
