"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[2405],{
...
;// CONCATENATED MODULE: ./src/views/apps/teacher/list/Sidebar.js
...
var SidebarNewUsers = function SidebarNewUsers(_ref) {
  ...
  var _useState9 = (0,react.useState)("fullTime"),
      _useState10 = (0,slicedToArray/* default */.Z)(_useState9, 2),
      regime = _useState10[0],
      setRegime = _useState10[1];
  ...
  var onSubmit = function onSubmit(e) {
    ...
    (0,utlis/* apiCall */.k_)(utlis/* insert */.$T, [api_urls/* TEACHER_URL */.uP, {
      avatar: avatar,
      gender: gender,
      salary: salary,
      note: note,
      ...
      regime: regime,
      phone: phone
    }], true, react_toastify_esm/* toast */.Am, dispatch, "teacherCreatedSuccessfully", "", onSuccess, onFail);
  };
...
;// CONCATENATED MODULE: ./src/views/apps/teacher/list/columns.js
// ** React Imports
 // ** Custom Components
...
var columns = function columns(deleteTeacher, intl, ability, history) {
  return [{
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        onClick: function onClick() {
          return history.push("/apps/teacher/view/".concat(row.id));
        },
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(UncontrolledDropdown/* default */.Z, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownToggle/* default */.Z, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            ...
            to: "/apps/teacher/view/".concat(row.id),
            className: "w-100",
          ...
          }), ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.TEACHER_SUBJECT */.k.TEACHER_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            tag: react_router_dom/* Link */.rU,
            to: "/apps/teacher/edit/".concat(row.id),
            className: "w-100",
          ...
          }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.TEACHER_SUBJECT */.k.TEACHER_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            className: "w-100",
            onClick: function onClick() {
              return deleteTeacher(row.id);
            },
...
;// CONCATENATED MODULE: ./src/views/apps/teacher/list/Table.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Row/* default */.Z, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.TEACHER_SUBJECT */.k.TEACHER_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
          color: "primary",
          onClick: toggleSidebar,
...
var TeachersList = function TeachersList() {
  ...
  var getData = function getData(i, s, o, f) {
    (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* TEACHERS_URL */.dT, i, s, o, f], true, react_toastify_esm/* toast */.Am, dispatch, null, "somethingWrong", function (res) {
      return setData(res);
    }, null);
  };
  ...
  var deleteTeacher = function deleteTeacher(id) {
    (0,customComponents_Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* TEACHER_URL */.uP, id], true, react_toastify_esm/* toast */.Am, dispatch, "teacherDeletedSuccessfully", "somethingWrong", function () {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(index_cjs/* default */.ZP, {
          ...
          columns: columns(deleteTeacher, intl, ability, history),
...
/* harmony default export */ var Table = (TeachersList);
// EXTERNAL MODULE: ./src/@core/scss/react/apps/app-users.scss
var app_users = __webpack_require__(61360);
;// CONCATENATED MODULE: ./src/views/apps/teacher/list/index.js
// ** User List Component
 // ** Styles
