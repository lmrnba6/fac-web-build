"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[4078],{
...
var users = __webpack_require__(39646);
...
var components_avatar = __webpack_require__(68138);
...
;// CONCATENATED MODULE: ./src/views/apps/parent/list/Sidebar.js
...
var SidebarNewUsers = function SidebarNewUsers(_ref) {
  ...
  var _useState7 = (0,react.useState)(""),
      ...
      phone2 = _useState8[0],
      setPhone2 = _useState8[1];

  var _useState9 = (0,react.useState)("male"),
  ...
  var _useState17 = (0,react.useState)(""),
      ...
      avatar = _useState18[0],
      setAvatar = _useState18[1];
  ...
  var StudentsComponent = function StudentsComponent(_ref2) {
    var data = _ref2.data,
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsx)(index_a7690a33_esm.c.Option, _objectSpread(_objectSpread({}, props), {}, {
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(components_avatar/* default */.Z, {
  ...
  var handleStudents = function handleStudents(list) {
    var returnList = [];
    ...
    setStudents(returnList);
  };

  var isSaveDisabled = !name || !(children !== null && children !== void 0 && children.length);
  ...
  var onSubmit = function onSubmit(e) {
    ...
    (0,utlis/* apiCall */.k_)(utlis/* insert */.$T, [api_urls/* PARENT_URL */.gV, {
      avatar: avatar,
      gender: gender,
      note: note,
      email: email,
      ...
      phone2: phone2,
      children: children
    }], true, react_toastify_esm/* toast */.Am, dispatch, "parentCreatedSuccessfully", "", onSuccess, onFail);
  };

  var getStudents = function getStudents(val) {
    if (val) {
      clearTimeout(timer);
      setTimer(setTimeout(function () {
        (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* STUDENTS_URL */.Hr, 0, 20, [["name", "asc"]], {
          ...
          return handleStudents(data.rows);
        }, null);
      }, 700));
    }
  };
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Media/* default */.Z, {
        ...
        children: [error && /*#__PURE__*/(0,jsx_runtime.jsxs)(Alert/* default */.Z, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* default */.Z, {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(users/* default */.Z, {
              className: "mx-1",
              size: 14
          ...
          name: "phone2",
          placeholder: "",
          invalid: submitted && phone2 && phone.length !== 10,
          invalidtext: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
            id: "phoneLengthError"
          }),
          onChange: function onChange(e) {
            return setPhone2(e.target.value.replace(/ /g, ""));
          },
          prepend: {
            icon: /*#__PURE__*/(0,jsx_runtime.jsx)(icons_phone/* default */.Z, {
              size: 14
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsx)((react_webcam_default()), {
            ...
            children: function children(_ref3) {
              var getScreenshot = _ref3.getScreenshot;
...
;// CONCATENATED MODULE: ./src/views/apps/parent/list/columns.js
// ** React Imports
 // ** Custom Components
...
var columns = function columns(deleteParent, intl, ability, history) {
  return [{
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        onClick: function onClick() {
          return history.push("/apps/parent/view/".concat(row.id));
        },
        className: "d-flex justify-content-left align-items-center cursor-pointer",
        children: [row.avatar ? /*#__PURE__*/(0,jsx_runtime.jsx)(components_avatar/* default */.Z, {
          img: row.avatar,
          className: "mr-1"
        }) : /*#__PURE__*/(0,jsx_runtime.jsx)(components_avatar/* default */.Z, {
          color: "light-danger",
          className: "mr-1",
          content: row.name,
          initials: true
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(Badge/* default */.Z, {
        ...
        pill: true,
        color: "light-primary",
        children: [row.children, " ", intl.formatMessage({
          id: "children"
        })]
      });
    }
    ...
    sortable: false,
    cell: function cell(row) {
      return (0,Utils/* formatPhone */.CN)(row.phone2);
    }
  }, {
    name: intl.formatMessage({
      id: "status"
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(UncontrolledDropdown/* default */.Z, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownToggle/* default */.Z, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            ...
            to: "/apps/parent/view/".concat(row.id),
            className: "w-100",
          ...
          }), ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.PARENT_SUBJECT */.k.PARENT_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            tag: react_router_dom/* Link */.rU,
            to: "/apps/parent/edit/".concat(row.id),
            className: "w-100",
          ...
          }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.PARENT_SUBJECT */.k.PARENT_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            className: "w-100",
            onClick: function onClick() {
              return deleteParent(row.id);
            },
...
;// CONCATENATED MODULE: ./src/views/apps/parent/list/Table.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Row/* default */.Z, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.PARENT_SUBJECT */.k.PARENT_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
          color: "primary",
          onClick: toggleSidebar,
...
var ParentsList = function ParentsList() {
  ...
  var getData = function getData(i, s, o, f) {
    (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* PARENTS_URL */.jh, i, s, o, f], true, react_toastify_esm/* toast */.Am, dispatch, null, "somethingWrong", function (res) {
      return setData(res);
    }, null);
  };
  ...
  var onGenderChange = function onGenderChange(gender) {
    ...
    getData(1, pageSize, order, Table_objectSpread(Table_objectSpread({}, filter), {}, {
      gender: gender
    }));
  };
  ...
  var onStatusChange = function onStatusChange(s) {
    ...
    setFilter(Table_objectSpread(Table_objectSpread({}, filters), filters));
    getData(1, pageSize, order, Table_objectSpread(Table_objectSpread({}, filters), filters));
  };
  ...
  var deleteParent = function deleteParent(id) {
    (0,customComponents_Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* PARENT_URL */.gV, id], true, react_toastify_esm/* toast */.Am, dispatch, "parentDeletedSuccessfully", "somethingWrong", function () {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(index_cjs/* default */.ZP, {
          ...
          columns: columns(deleteParent, intl, ability, history),
...
/* harmony default export */ var Table = (ParentsList);
// EXTERNAL MODULE: ./src/@core/scss/react/apps/app-users.scss
var app_users = __webpack_require__(61360);
;// CONCATENATED MODULE: ./src/views/apps/parent/list/index.js
// ** User List Component
 // ** Styles
