"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[8596],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ car_list; }
});
...
;// CONCATENATED MODULE: ./src/views/apps/car/list/columns.js
// ** React Imports
 // ** Custom Components
...
var columns = function columns(deleteCar, editCar, viewCar, ability, intl) {
  return [{
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(UncontrolledDropdown/* default */.Z, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownToggle/* default */.Z, {
          ...
          right: true,
          children: [ability.can(actions/* ACTIONS.SEE_ACTION */.a.SEE_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
          ...
          }), ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            tag: react_router_dom/* Link */.rU,
            to: "#",
            onClick: function onClick() {
              return editCar(row);
          ...
          }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            className: "w-100",
            onClick: function onClick() {
              return deleteCar(row.id);
            },
...
;// CONCATENATED MODULE: ./src/views/apps/car/list/Sidebar.js
...
var Sidebar = function Sidebar(props) {
  ...
  var _useState3 = (0,react.useState)(car.capacity),
      _useState4 = (0,slicedToArray/* default */.Z)(_useState3, 2),
      capacity = _useState4[0],
      setCapacity = _useState4[1];

  var _useState5 = (0,react.useState)(car.name || ""),
  ...
  var handleCarsFetched = function handleCarsFetched(res) {
    setCapacity(res.capacity);
    setName(res.name);
    setDescription(res.description);
  };

  var initCar = function initCar() {
    if (car.id) {
      (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* CAR_URL */.ko, car.id], true, react_toastify_esm/* toast */.Am, dispatch, "", "somethingWrong", handleCarsFetched, toggleSidebar);
    }
  };
  ...
  var onCarSuccess = function onCarSuccess() {
    toggleSidebar();
    refresh();
  };
  ...
  var onCreate = function onCreate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* insert */.$T, [api_urls/* CAR_URL */.ko, {
        capacity: capacity,
        name: name,
        description: description
      }], true, react_toastify_esm/* toast */.Am, dispatch, "carCreatedSuccessfully", "", onCarSuccess, onFail);
    }
  };
  ...
  var onUpdate = function onUpdate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* CAR_URL */.ko, car.id, {
        ...
        name: name,
        description: description
      }], true, react_toastify_esm/* toast */.Am, dispatch, "carUpdatedSuccessfully", "", onCarSuccess, onFail);
    }
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(Modal/* default */.Z, {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ModalHeader/* default */.Z, {
      ...
      children: [error && /*#__PURE__*/(0,jsx_runtime.jsxs)(es_Alert/* default */.Z, {
        ...
        onSubmit: car.id ? onUpdate : onCreate,
...
;// CONCATENATED MODULE: ./src/views/apps/car/list/carDetails.js
...
var CarDetailsModal = function CarDetailsModal(props) {
  ...
  var _useState = (0,react.useState)({}),
      _useState2 = (0,slicedToArray/* default */.Z)(_useState, 2),
      currentCar = _useState2[0],
      setCurrentCar = _useState2[1];
  ...
  var onDelete = function onDelete() {
    (0,Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* CAR_URL */.ko, car.id], true, react_toastify_esm/* toast */.Am, dispatch, "carDeletedSuccessfully", "somethingWrong", onDeleteSuccess, null);
      }
    });
  };

  var handleCarFetched = function handleCarFetched(res) {
    setCurrentCar(res);
  };

  function getCar() {
    (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* CAR_URL */.ko, car.id], true, react_toastify_esm/* toast */.Am, dispatch, "", "somethingWrong", handleCarFetched, null);
  }
  ...
  return car ? /*#__PURE__*/(0,jsx_runtime.jsxs)(Modal/* default */.Z, {
    scrollable: true,
    className: "modal-xl",
    isOpen: openDetails,
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ModalHeader/* default */.Z, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Nav/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.SEE_ACTION */.a.SEE_ACTION, subjects/* SUBJECTS.SCHEDULE_SUBJECT */.k.SCHEDULE_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsx)(NavItem/* default */.Z, {
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)(NavLink/* default */.Z, {
            active: active === "2",
            onClick: function onClick() {
              toggle("2");
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
              ...
              children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Media/* default */.Z, {
                ...
                children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Badge/* default */.Z, {
                  color: "light-primary",
                  children: [currentCar.capacity, " ", intl.formatMessage({
                    id: "places"
                  })]
                })
              })]
              ...
              children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Media/* default */.Z, {
                ...
                className: "font-weight-bolder  ml-1",
                children: currentCar.description
              })]
            })]
          })
    ...
    }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(ModalFooter/* default */.Z, {
      children: [ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsx)(Button/* default */.Z, {
        color: "danger",
        onClick: onDelete,
        outline: true,
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
      ...
      }), ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsx)(Button/* default */.Z, {
        color: "primary",
        onClick: onEdit,
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
          id: "edit"
...
/* harmony default export */ var carDetails = (CarDetailsModal);
;// CONCATENATED MODULE: ./src/views/apps/car/list/Table.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Row/* default */.Z, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.CAR_SUBJECT */.k.CAR_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
          color: "primary",
          onClick: onAdd,
...
var CarList = function CarList() {
  ...
  var getData = function getData(pageIndex, pageSize, order, filter) {
    (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* CARS_URL */.QE, pageIndex, pageSize, order, filter], true, react_toastify_esm/* toast */.Am, dispatch, null, "somethingWrong", handleData, null);
  };
  ...
  var deleteCar = function deleteCar(id) {
    (0,Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* CAR_URL */.ko, id], true, react_toastify_esm/* toast */.Am, dispatch, "carDeletedSuccessfully", "somethingWrong", function () {
  ...
  var editCar = function editCar(s) {
    setCar(s);
    toggleSidebar();
  };

  var viewCar = function viewCar(s) {
    setCar(s);
    toggleDetails();
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(index_cjs/* default */.ZP, {
          ...
          columns: columns(deleteCar, editCar, viewCar, ability, intl),
      ...
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(carDetails, {
        dispatch: dispatch,
        setCar: setCar,
...
/* harmony default export */ var Table = (CarList);
;// CONCATENATED MODULE: ./src/views/apps/car/list/index.js
// ** User List Component
// ** Styles
...
/* harmony default export */ var car_list = (List);
