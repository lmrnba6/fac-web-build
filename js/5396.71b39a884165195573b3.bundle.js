"use strict";
(self["webpackChunksmart_interact"] = self["webpackChunksmart_interact"] || []).push([[5396],{
...
;// CONCATENATED MODULE: ./src/views/apps/route/list/columns.js
// ** React Imports
 // ** Custom Components
...
var columns = function columns(deleteRoute, editRoute, viewRoute, ability, intl) {
  return [{
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* default */.Z, {
        ...
        pill: true,
        color: row.direction === "fromSchool" ? "light-success" : "light-danger",
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* default */.Z, {
        ...
        pill: true,
        color: "light-primary",
        children: "".concat(row.stops || 0, " ").concat(intl.formatMessage({
          id: "stops"
        }))
      });
    }
    ...
    cell: function cell(row) {
      return /*#__PURE__*/(0,jsx_runtime.jsxs)(UncontrolledDropdown/* default */.Z, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownToggle/* default */.Z, {
          ...
          right: true,
          children: [ability.can(actions/* ACTIONS.SEE_ACTION */.a.SEE_ACTION, subjects/* SUBJECTS.ROUTE_SUBJECT */.k.ROUTE_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
          ...
          }), ability.can(actions/* ACTIONS.EDIT_ACTION */.a.EDIT_ACTION, subjects/* SUBJECTS.ROUTE_SUBJECT */.k.ROUTE_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            tag: react_router_dom/* Link */.rU,
            to: "#",
            onClick: function onClick() {
              return editRoute(row);
            },
            className: "w-100",
          ...
          }), ability.can(actions/* ACTIONS.DELETE_ACTION */.a.DELETE_ACTION, subjects/* SUBJECTS.ROUTE_SUBJECT */.k.ROUTE_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(DropdownItem/* default */.Z, {
            className: "w-100",
            onClick: function onClick() {
...
// EXTERNAL MODULE: ./node_modules/react-feather/dist/icons/repeat.js
var repeat = __webpack_require__(99933);
// EXTERNAL MODULE: ./node_modules/react-feather/dist/icons/clipboard.js
var clipboard = __webpack_require__(70616);
// EXTERNAL MODULE: ./node_modules/react-feather/dist/icons/git-commit.js
var git_commit = __webpack_require__(62874);
...
;// CONCATENATED MODULE: ./src/views/apps/route/list/Sidebar.js
...
var Sidebar = function Sidebar(props) {
  ...
  var _useState3 = (0,react.useState)(false),
      ...
      submittedStop = _useState4[0],
      setSubmittedStop = _useState4[1];

  var _useState5 = (0,react.useState)(route.description),
      _useState6 = (0,slicedToArray/* default */.Z)(_useState5, 2),
      description = _useState6[0],
      setDescription = _useState6[1];

  var _useState7 = (0,react.useState)(route.name || ""),
      _useState8 = (0,slicedToArray/* default */.Z)(_useState7, 2),
      name = _useState8[0],
      setName = _useState8[1];

  var _useState9 = (0,react.useState)(route.direction || ""),
  ...
  var _useState11 = (0,react.useState)(null),
      ...
      errorStop = _useState12[0],
      setErrorStop = _useState12[1];
  ...
  var _useState15 = (0,react.useState)(false),
      ...
      openStop = _useState16[0],
      setOpenStop = _useState16[1];

  var _useState17 = (0,react.useState)([]),
      _useState18 = (0,slicedToArray/* default */.Z)(_useState17, 2),
      stops = _useState18[0],
      setStops = _useState18[1];
  ...
  var saveStop = function saveStop() {
    ...
    var edit = stops.find(function (t) {
      return t.id === stop.id;
    });

    if (edit) {
      var duplicate = stops.find(function (t) {
        return t.name === stop.name && t.id !== stop.id;
      });
      ...
      var find = stops.find(function (t) {
      ...
      if (find) {
        ...
        stop.id = new Date().getTime();
        setStops(sortStops([].concat((0,toConsumableArray/* default */.Z)(stops), [stop])));
        setOpenStop(false);
      }
    }
  };

  var sortStops = function sortStops(s) {
    return s.sort(function (a, b) {
      return Number(a.order) - Number(b.order);
    });
  };

  var deleteStop = function deleteStop(k) {
    setStops(sortStops(stops.filter(function (y) {
      return y.name !== k.name;
    })));
  };

  var editStop = function editStop(k) {
    var c = stops.find(function (y) {
      return y.name === k.name;
    });
  ...
  var handleRoutesFetched = function handleRoutesFetched(res) {
    setStops(res.stops);
  ...
  var initRoute = function initRoute() {
    if (route.id) {
      (0,utlis/* apiCall */.k_)(utlis/* get */.U2, [api_urls/* ROUTE_URL */.wN, route.id], true, react_toastify_esm/* toast */.Am, dispatch, "", "somethingWrong", handleRoutesFetched, toggleSidebar);
    }
  };
  ...
  var isSaveButtonDisabled = !name || !direction;
  ...
  var onCreate = function onCreate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* insert */.$T, [api_urls/* ROUTE_URL */.wN, {
        stops: stops,
        description: description,
        name: name,
        direction: direction
      }], true, react_toastify_esm/* toast */.Am, dispatch, "routeCreatedSuccessfully", "", onRouteSuccess, onFail);
    }
  };
  ...
  var onUpdate = function onUpdate(e) {
    ...
    if (!isSaveButtonDisabled) {
      (0,utlis/* apiCall */.k_)(utlis/* update */.Vx, [api_urls/* ROUTE_URL */.wN, route.id, {
        stops: stops,
        description: description,
        name: name,
        direction: direction
      }], true, react_toastify_esm/* toast */.Am, dispatch, "routeUpdatedSuccessfully", "", onRouteSuccess, onFail);
    }
  };
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ModalHeader/* default */.Z, {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsx)("h5", {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
          id: "".concat(route.id ? "edit" : "add", "Route")
        })
      })
      ...
      children: [error && /*#__PURE__*/(0,jsx_runtime.jsxs)(es_Alert/* default */.Z, {
        ...
        onSubmit: route.id ? onUpdate : onCreate,
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Field/* default */.Z, {
          ...
          prepend: {
            icon: /*#__PURE__*/(0,jsx_runtime.jsx)(repeat/* default */.Z, {
              size: 14
            })
          },
          invalid: submitted && !direction,
          requireStar: true,
          invalidtext: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
            id: "required"
          }),
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.STOP_SUBJECT */.k.STOP_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "divider",
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              ...
              children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
                ...
                color: "dark",
                onClick: function onClick() {
                  return setOpenStop(true);
                },
                children: [/*#__PURE__*/(0,jsx_runtime.jsx)(git_commit/* default */.Z, {
                  size: 14
                }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
        ...
        }), stops && !!stops.length && ability.can(actions/* ACTIONS.SEE_ACTION */.a.SEE_ACTION, subjects/* SUBJECTS.STOP_SUBJECT */.k.STOP_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* default */.Z, {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("thead", {
              ...
              children: stops.map(function (p, k) {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ModalHeader/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
          id: stop !== null && stop !== void 0 && stop.id ? "editStop" : "addStop"
        })
      }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ModalBody/* default */.Z, {
        children: [errorStop && /*#__PURE__*/(0,jsx_runtime.jsxs)(es_Alert/* default */.Z, {
          color: "danger",
          className: "d-flex align-items-center",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            className: "alert-body font-small-2 flex-grow-1",
          ...
          requireStar: true,
          invalid: submittedStop && !stop.order,
          invalidtext: /*#__PURE__*/(0,jsx_runtime.jsx)(message/* default */.Z, {
            id: "required"
          }),
          prepend: {
...
;// CONCATENATED MODULE: ./src/views/apps/route/list/Table.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Row/* default */.Z, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Col/* default */.Z, {
        ...
        }), ability.can(actions/* ACTIONS.WRITE_ACTION */.a.WRITE_ACTION, subjects/* SUBJECTS.ROUTE_SUBJECT */.k.ROUTE_SUBJECT) && /*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* default.Ripple */.Z.Ripple, {
          color: "primary",
          onClick: onAdd,
...
var RouteList = function RouteList() {
  ...
  var getData = function getData(pageIndex, pageSize, order, filter) {
    (0,utlis/* apiCall */.k_)(utlis/* getAllPaged */.Ki, [api_urls/* ROUTES_URL */.iJ, pageIndex, pageSize, order, filter], true, react_toastify_esm/* toast */.Am, dispatch, null, "somethingWrong", handleData, null);
  };
  ...
  var deleteRoute = function deleteRoute(id) {
    (0,Alert/* SweetAlert */.o)(intl.formatMessage({
      ...
      if (res.value) {
        (0,utlis/* apiCall */.k_)(utlis/* remove */.Od, [api_urls/* ROUTE_URL */.wN, id], true, react_toastify_esm/* toast */.Am, dispatch, "routeDeletedSuccessfully", "somethingWrong", function () {
  ...
  var editRoute = function editRoute(s) {
    setRoute(s);
    toggleSidebar();
  };
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(react.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card/* default */.Z, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(index_cjs/* default */.ZP, {
          ...
          columns: columns(deleteRoute, editRoute, viewRoute, ability, intl),
      ...
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(routeDetails/* default */.Z, {
        dispatch: dispatch,
        setRoute: setRoute,
...
/* harmony default export */ var list_Table = (RouteList);
;// CONCATENATED MODULE: ./src/views/apps/route/list/index.js
// ** User List Component
// ** Styles
